...
function elkinGay() 
{
    if(document.getElementById("valueOfP").selectedIndex==1)
    {
        variables[1]="f";
    }
    else
    ...
    if(document.getElementById("valueOfQ").selectedIndex==1)
    {
        variables[3]="f"
    }
    else
    ...
    if(document.getElementById("valueOfR").selectedIndex==1)
    {
        variables[5]="f"
    }
    else
...
function tipoTabla(){
    ...
    var tipo = "";
    if(TAUTOLOGICA===tipo_tabla.length) tipo="TAUTOLOGÍA: La columna resultante contiene solamente valores verdaderos";
    else if(CONTRADICCION===tipo_tabla.length) tipo="CONTRADICCIÓN: La columna resultante contiene solamente valores falsos";
    else tipo="CONTINGENCIA: La columna resultante contiene valores verdaderos y falsos";
